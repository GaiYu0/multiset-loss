...
do
  ...
  python evaluate.py --criterion=regression_loss --datapath=data-with-replacement --gpu=1 --interval=100 --n=${n_digits} --tensorboard-log=jsd-loss --tensorboard-postfix=re${n_digits} &
